using Everaldo.Cardoso.Araujo.C19BR.API.NHibernate;
using Everaldo.Cardoso.Araujo.C19BR.Framework.Conversion;
...
namespace Everaldo.Cardoso.Araujo.C19BR.Framework.Bases
{
